...
7. 熟悉掌握编译器前端中端。熟悉递归下降分析算法，熟练掌握上下文无关文法和 flex/bison 以及 antlr4语法解析工具。
7. 了解编译器框架，了解 llvm。了解深度学习编译器框架和 tvm。
7. 掌握 kickstart 定制化 centos 操作系统镜像。

## 项目经验

**2022.02~2022.04　　　编译器开发工程师**<br>**描述：** 负责深度学习编译器的调研和开发，通过tvm对深度学习模型进行优化和编译，部署到燧原芯片。<br>**主要工作：**

1. 调研深度学习编译器，了解深度学习编译器框架。
1. 调研 tvm 编译器框架，了解 tvm 的编译流程和开发流程。
1. 了解和阅读近5年所有顶会相关论文，编写综述初稿。
1. 编写一篇关于auto tuning的专利。
